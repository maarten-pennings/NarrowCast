...
# n4.channel.xml.py - Script to convert NS data to rss
...
# Create a python script (e.g. ns.channel.xml.py) and assign rights
#   sudo chown maarten:www-data ns.channel.xml.py
#   sudo chmod 755 ns.channel.xml.py

# Map python script 'ns.channel.xml.py' to url 'rss/ns.channel.xml'
#   Edit configuration file    
#     sudo vi /etc/apache2/sites-available/000-default.conf
#   and add the line in the section <VirtualHost *:80>
#     WSGIScriptAlias /rss/ns.channel.xml /var/www/html/rss/ns.channel.xml.py
